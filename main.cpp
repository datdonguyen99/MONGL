...
int readFile(const char *filename, int &NID, int &N1, int &N5, int &k,
             string *&ID, string *&input1, string *&input2, string *&input3,
             string *&input4, string *&input5, string *&input6,
             string *&input7Matrix, string *&input7Str) {
...
int main(int argc, const char *argv[]) {
  ...
  bool isRead = readFile(filename, NID, N1, N5, k, ID, input1, input2, input3,
                         input4, input5, input6, input7Matrix, input7Str);

  if (!isRead) {
    cout << "File cannot be read!";
    return 1;
  } else {
    cout << "Answer for task 1: " << readyForBattle(ID, NID, input1, N1)
         << endl;
    cout << "Answer for task 2: " << decode(input2[0], input2[1]) << endl;
    cout << "Answer for task 3: " << findRoute(*input3) << endl;
    cout << "Answer for task 4: " << decodeVfunction(input4[0], input4[1])
         << endl;
    cout << "Answer for task 5: " << findBetrayals(input5, N5) << endl;
    cout << "Answer for task 6: " << attack(input6) << endl;
    cout << "Answer for task 7: "
         << calculateNoOfWaitingDays(*input7Str, input7Matrix, k) << endl;
  }
  return 0;
}
